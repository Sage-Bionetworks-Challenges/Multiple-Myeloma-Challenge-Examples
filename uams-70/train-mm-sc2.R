...
## docker build -t docker.synapse.org/syn7237116/uams-70:version1 .
## docker images
## docker login docker.synapse.org
## docker push docker.synapse.org/syn7237116/uams-70:version1
...
res <- uams.70.entrez(X = as.matrix(expr), y = y, threshold = NULL)$obj
